...
| 엔티티 페이지 (스튜디오·게임, `wiki/entities/`) | 73개 |
...
총 약 265개 md 페이지가 wikilink로 연결되어 있고, 모두 frontmatter(`type`, `sources`, `related`, `confidence` 등) 기반으로 구조화되어 있어 추후 graph 추론·검색 활용 가능한 상태입니다.
