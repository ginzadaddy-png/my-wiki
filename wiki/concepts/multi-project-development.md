...
| 스튜디오 | 규모 | 방식 | 결과 |
|---------|------|------|------|
| [[naughty-dog]] | 대형 | 한 번에 풀 프로덕션 1개 + 프리프로덕션 복수 | 2021년 기준 아직 동시 풀 프로덕션 미달성 |
| [[fromsoftware]] | 중형 (300명) | 유동적 배치 + 피크 타임 엇갈리기 | 엘든링+AC6 사실상 동시 개발 성공 |
| [[embark-studios]] | 소형 (360명) | 파이프라인 효율화 + 규모 억제 | 4개 게임 목표, 인원 성장 없이 달성 계획 |
